...
function InputProdutoAlterar({fetchItemSelecionado,nome,mostrarOpcoes,setMostrarOpcoes,setMostrarOpcoesSegundoInput,selecionarNomeValor, nomeValor, itemSelecionado, setNomeValor}) {
